...
# You can modify the following line to match the location of your files:
...
def run_steps(prj, steps=get_steps()):
...
if __name__ == "__main__":
    ...
    parser.add_argument("prj", nargs="+", type=str, help="project id (in lower case)")
    parser.add_argument(
        "-s",
        "--steps",
        nargs="+",
